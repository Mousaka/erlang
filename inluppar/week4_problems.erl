...
-export([test_easy/0, test_hard/0, dump/2, test_count_atoms/0]).
...
test_easy() ->
	...
	"<b>ddf</b><b>asdd</b><b>BB<i>II</i>CC</b>" = M:expand_markup("**ddf****asdd****BB__II__CC**"),
    horray.

test_hard() ->			%U will need accumilation technic
